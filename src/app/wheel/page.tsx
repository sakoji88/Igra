      ...
      <div className="grid gap-6">
        <section className="rounded-3xl border border-zinc-800 bg-zinc-950/90 p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3 text-sm text-zinc-300">
            ...
            <div className="rounded-full border border-zinc-700 px-4 py-2">Крутки владельца: {state?.availableWheelSpins ?? 0}</div>
            <div className="rounded-full border border-zinc-700 px-4 py-2">Колесо видят все, но тратятся крутки владельца</div>
          </div>
        </section>
        <WheelSpinner
